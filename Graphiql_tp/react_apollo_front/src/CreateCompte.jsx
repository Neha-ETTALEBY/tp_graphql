...
const styles = {
  container: {
    ...
    backgroundColor: 'var(--card-bg)', // Fond adapté au thème sombre
    borderRadius: '8px',
  ...
  heading: {
    ...
    fontSize: '1.8rem',
    marginBottom: '20px',
    color: '#246741', // Couleur principale (vert foncé)
  },
  form: {
    display: 'flex',
  ...
  button: {
    ...
    fontSize: '1rem',
    color: '#fff',
    backgroundColor: '#246741', // Bouton avec la couleur principale
    border: 'none',
    borderRadius: '5px',
    cursor: 'pointer',
